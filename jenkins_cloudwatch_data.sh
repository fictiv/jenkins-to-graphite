...
cmd="./jenkins-to-graphite.py --jenkins-url=https://prod-pipeline.fictiv.com/jenkins/ --jenkins-user=jim@fictiv.com --jenkins-password=ebec5039c7f6dec7a9e0d79d311376fc --job=worker-3dp-geometry"

exec $cmd 2>&1 | /usr/bin/logger -t worker_3dp_geometry_cloudwatch_data

cmd="./jenkins-to-graphite.py --jenkins-url=https://prod-pipeline.fictiv.com/jenkins/ --jenkins-user=jim@fictiv.com --jenkins-password=ebec5039c7f6dec7a9e0d79d311376fc --job=worker-cnc-geometry"
